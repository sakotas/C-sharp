...
WriteLine(num1 * num1 == num2?$"Второе число '{num2}' является квадратом первого числа '{num1}'":num2 * num2 == num1?$"Первое число '{num1}' является квадратом второго числа '{num2}'":"Ни одно число не является квадратом другого");